  ...
  return (
    <div className="fixed bottom-4 right-4 z-40 flex flex-col items-end pointer-events-auto">
      <motion.button
        ...
        className="w-12 h-12 flex items-center justify-center bg-vintage-navy/40 border border-electric-blue/50 text-electric-blue backdrop-blur-md transition-all duration-300"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="mb-4 shard-epistemic-wrapper"
          >
