            ...
            <main className="relative z-10 w-full max-w-md px-6 text-center">
                ...
                >
                    ...
                    <button
                        ...
                        disabled={btnLoading}
                        className="group relative flex items-center justify-center gap-4 py-3.5 px-8 rounded-2xl w-full max-w-xs overflow-hidden transition-all duration-500 disabled:opacity-70 disabled:cursor-not-allowed"
                    ...
                    >
                        ...
                        {btnLoading ? (
                            ...
                            <>
                                <motion.div
                                    className="w-5 h-5 rounded-full border-2 border-white/20 border-t-white/80 relative z-10 flex-shrink-0"
                                    animate={{ rotate: 360 }}
                                    transition={{ duration: 0.8, repeat: Infinity, ease: 'linear' }}
                                />
                                <span className="font-medium tracking-wide text-white/60 relative z-10" style={{ fontFamily: "'Space Grotesk', sans-serif" }}>
                                    Conectando...
                                </span>
                            </>
                        ) : (
